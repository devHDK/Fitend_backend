...
import {IWorkoutCreate, IWorkoutFindAll, IWorkoutList} from '../interfaces/workout'
...
export {tableName, tableWorkoutExercise, create, createRelationExercises, findAll}
